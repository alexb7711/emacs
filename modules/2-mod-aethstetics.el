  ...
  (if (eq system-type 'windows-nt)
      (progn
        ...
        (when (mod/font-available-p "Iosevka Nerd Font")
          (set-face-attribute 'variable-pitch nil :font "Iosevka Nerd Font" :weight 'normal :height 137))
        (when (mod/font-available-p "Iosevka NF")
          (set-face-attribute 'variable-pitch nil :font "Iosevka NF" :weight 'normal :height 137)))
    (progn
      (when (mod/font-available-p "Mononoki Nerd Font")
      ...
      (when (mod/font-available-p "Iosevka Nerd Font")
        (set-face-attribute 'variable-pitch nil :font "Iosevka Nerd Font" :weight 'normal :height 140))
      (when (mod/font-available-p "Iosevka NF")
        (set-face-attribute 'variable-pitch nil :font "Iosevka NF" :weight 'normal :height 140))))
